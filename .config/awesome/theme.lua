...
theme.taglist_squares_sel   = gears.surface.load_from_shape(dpi(24), dpi(1.6), gears.shape.rectangle, theme.fg_focus)
theme.taglist_squares_unsel = gears.surface.load_from_shape(dpi(24), dpi(1.6), gears.shape.rectangle, theme.fg_normal)
